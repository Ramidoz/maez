# Deferred Credential/Key-Management Seed - S7.3 v20 Scope Cut

This working seed preserves the v19 S7.3 credential/key-management drafting surface after the v20 big-cut decision. It is intentionally parked outside the S7.3 v1 core spec so the future credential-management slice starts with the drafted work and review history intact, not from memory.

**Source preserved below:** `13a00d97766d57fafe62c619b5b1880079212078:docs/slices/s7.3-guarded-self-modification-execution/spec.md`.

**Future-slice covenant question:** the WebAuthn registration signature-scope ruling moves here. The future slice must decide whether founder-signs-at-begin / writes-at-finish satisfies the founder-signs-the-actual-change principle, or choose a different registration mechanism.
