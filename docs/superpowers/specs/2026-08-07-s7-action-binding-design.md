...
| `core/governance/s7_guarded_execution.py` | `S7GuardedStateStore.put_artifact_under_consultation_exemption` | durable_writer | definition | 3440 |
| `core/governance/s7_guarded_execution.py` | `S7VoiceConsultationBundleStore.put_bundle` | durable_writer | definition | 2435 |
| `core/governance/s7_guarded_execution.py` | `_bundle_content_hash_valid` | hash | call:s7_voice_consultation_bundle_hash | 3040 |
| `core/governance/s7_guarded_execution.py` | `_bundle_matches_expected_hash_binding` | validator | definition | 3013 |
...
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_expected_r11_exemption_evidence_contract | 2922 |
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_r11_exemption_evidence_contract | 2919 |
| `core/governance/s7_guarded_execution.py` | `_voice_bundle_from_row` | source_bundle | call:S7VoiceConsultationBundle | 1687 |
| `core/governance/s7_guarded_execution.py` | `_voice_validation_result_v2` | hash | call:s7_voice_consultation_bundle_hash | 1821 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | call:S7VoiceSourceBundleHashBinding | 1115 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:maez_voice_consultation_hash | 1099 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:work_request_envelope_hash | 1098 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | definition | 1079 |
| `core/governance/s7_guarded_execution.py` | `get_for_source_ref` | source_bundle | call:S7VoiceConsultationBundle | 2536 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:authorization_store.put | 3590 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | validator | call:exemption_admits_for_artifact | 3567 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_under_consultation_exemption | 3576 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_with_bundle_reservation | 3582 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | constructor | definition | 3520 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:S7VoiceConsultationBundle | 1219 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:attempt_store.put | 1195 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:derive_s7_voice_source_bundle_hash_binding | 1177 |
...
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:self.authorization_store.put | 3473 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | call:self.authorization_store.put | 3517 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | definition | 3480 |
| `core/governance/s7_guarded_execution.py` | `put_bundle` | hash | call:s7_voice_consultation_bundle_hash | 2441 |
| `core/governance/s7_guarded_execution.py` | `put_voice_source_bundle_v2` | hash | call:s7_voice_consultation_bundle_hash | 1733 |
...
| `core/governance/s7_guarded_execution.py` | `s7_voice_consultation_bundle_hash` | hash | definition | 1524 |
| `core/governance/s7_guarded_execution.py` | `validate_s7_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 3264 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 1924 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:_voice_source_bundle_binding_hash | 1907 |
...
| `scripts/cuda_cutover.py` | `ValidatedCutoverSelection.__post_init__` | constructor | definition | 307 |
| `scripts/cuda_cutover.py` | `_action_params_hash_from_durable_selection` | hash | call:_cutover_action_preimage | 358 |
| `scripts/cuda_cutover.py` | `_action_params_hash_from_durable_selection` | hash | definition | 350 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | hash | call:_cutover_action_preimage | 3230 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | producer | call:_cutover_envelope_from_durable_selection | 3252 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | durable_writer | call:consume_for_execution_with_committed_row | 3387 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | producer | call:mint_consultation_exemption | 3258 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | renderer | call:render_request_statement | 3267 |
| `scripts/cuda_cutover.py` | `_conn` | constructor | call:_open_s7_connection_from_held_store | 1147 |
| `scripts/cuda_cutover.py` | `_cutover_action_preimage` | hash | definition | 316 |
| `scripts/cuda_cutover.py` | `_cutover_envelope_from_durable_selection` | hash | call:_cutover_action_preimage | 375 |
| `scripts/cuda_cutover.py` | `_cutover_envelope_from_durable_selection` | producer | call:build_work_request_envelope | 372 |
| `scripts/cuda_cutover.py` | `_cutover_envelope_from_durable_selection` | producer | definition | 361 |
| `scripts/cuda_cutover.py` | `_reconstruct_selected_cutover_at` | constructor | call:ValidatedCutoverSelection | 734 |
| `scripts/cuda_cutover.py` | `_reconstruct_selected_cutover_at` | constructor | definition | 534 |
| `scripts/cuda_cutover.py` | `_revalidate_r11_after_consume` | validator | call:revalidate_r11_exemption_for_consumption | 3368 |
| `core/governance/operator_user_boundary.py` | `anchored_transaction` | constructor | call:_open_s7_connection_from_held_store | 3477 |
| `scripts/cuda_cutover.py` | `open_existing_authorization_store` | constructor | call:_open_s7_connection_from_held_store | 984 |
| `scripts/cuda_cutover.py` | `publish_and_validate_burn` | execution_edge | call:consume_execution_grant_for_action | 1699 |
| `scripts/cuda_cutover.py` | `require_current_named_identity` | constructor | call:_require_verified_held_connection | 804 |
| `skills/surface/s7_ceremony_bridge.py` | `s7_request_envelope_hash_for_card` | hash | call:work_request_envelope_hash | 68 |
