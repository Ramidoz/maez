...
11. verify to_fingerprint_auth   == ffee1bcb…
12. verify to_fingerprint_bundle == b93735fe…
...
* **every** target fingerprint literal is recomputed from the frozen DDL
  in a scratch database and asserted;
