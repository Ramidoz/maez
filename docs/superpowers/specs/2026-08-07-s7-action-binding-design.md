...
| `core/governance/operator_user_boundary.py` | `render_request_statement` | renderer | call:RenderedRequestStatement | 5035 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | validator | call:consultation_exemption_admits | 4975 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | hash | call:maez_voice_consultation_hash | 4995 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | hash | call:work_request_envelope_hash | 5006 |
...
| `core/governance/s7_guarded_execution.py` | `S7GuardedStateStore.put_artifact_under_consultation_exemption` | durable_writer | definition | 3470 |
| `core/governance/s7_guarded_execution.py` | `S7VoiceConsultationBundleStore.put_bundle` | durable_writer | definition | 2465 |
| `core/governance/s7_guarded_execution.py` | `_bundle_content_hash_valid` | hash | call:s7_voice_consultation_bundle_hash | 3070 |
| `core/governance/s7_guarded_execution.py` | `_bundle_matches_expected_hash_binding` | validator | definition | 3043 |
...
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | validator | call:_expected_r11_exemption_evidence_contract | 250 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | hash | call:_r11_artifact_projection | 276 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | validator | call:_r11_exemption_evidence_contract | 249 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | durable_writer | definition | 242 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_expected_r11_exemption_evidence_contract | 166 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_expected_r11_exemption_evidence_contract | 172 |
...
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_r11_exemption_evidence_contract | 163 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_r11_exemption_evidence_contract | 171 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | durable_writer | definition | 129 |
| `core/governance/s7_guarded_execution.py` | `_r11_artifact_projection` | hash | definition | 212 |
| `core/governance/s7_guarded_execution.py` | `_r11_exemption_evidence_contract` | validator | definition | 94 |
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_expected_r11_exemption_evidence_contract | 2952 |
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_r11_exemption_evidence_contract | 2949 |
| `core/governance/s7_guarded_execution.py` | `_voice_bundle_from_row` | source_bundle | call:S7VoiceConsultationBundle | 1717 |
| `core/governance/s7_guarded_execution.py` | `_voice_validation_result_v2` | hash | call:s7_voice_consultation_bundle_hash | 1851 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | call:S7VoiceSourceBundleHashBinding | 1145 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:maez_voice_consultation_hash | 1129 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:work_request_envelope_hash | 1128 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | definition | 1109 |
| `core/governance/s7_guarded_execution.py` | `get_for_source_ref` | source_bundle | call:S7VoiceConsultationBundle | 2566 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:authorization_store.put | 3620 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | validator | call:exemption_admits_for_artifact | 3597 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_under_consultation_exemption | 3606 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_with_bundle_reservation | 3612 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | constructor | definition | 3550 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:S7VoiceConsultationBundle | 1249 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:attempt_store.put | 1225 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:derive_s7_voice_source_bundle_hash_binding | 1207 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:put_voice_source_bundle_v2 | 1281 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | hash | call:s7_voice_consultation_bundle_hash | 1278 |
...
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:_insert_r11_exemption_evidence | 3504 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | validator | call:exemption_admits_for_artifact | 3491 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:self.authorization_store.put | 3503 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | call:self.authorization_store.put | 3547 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | definition | 3510 |
| `core/governance/s7_guarded_execution.py` | `put_bundle` | hash | call:s7_voice_consultation_bundle_hash | 2471 |
| `core/governance/s7_guarded_execution.py` | `put_voice_source_bundle_v2` | hash | call:s7_voice_consultation_bundle_hash | 1763 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | constructor | call:S7AuthorizationArtifact | 358 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | source_bundle | call:_exemption_from_persisted_projection | 415 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:_expected_r11_exemption_evidence_contract | 322 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | hash | call:_r11_artifact_projection | 420 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:_r11_exemption_evidence_contract | 321 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:_require_verified_held_connection | 315 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:exemption_admits_for_artifact | 450 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | definition | 307 |
| `core/governance/s7_guarded_execution.py` | `s7_voice_consultation_bundle_hash` | hash | definition | 1554 |
| `core/governance/s7_guarded_execution.py` | `validate_s7_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 3294 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 1954 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:_voice_source_bundle_binding_hash | 1937 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:s7_voice_consultation_bundle_hash | 1940 |
...
| `core/governance/s7_webauthn_ceremony.py` | `_consume_backup_registration_authorization` | durable_writer | call:consume_for_execution | 1371 |
| `core/governance/s7_webauthn_ceremony.py` | `_generic_voice_evidence_revalidated_at_gate` | hash | call:maez_voice_consultation_hash | 1177 |
| `core/governance/s7_webauthn_ceremony.py` | `_generic_voice_evidence_revalidated_at_gate` | source_bundle | call:read_voice_source_bundle | 1186 |
| `core/governance/s7_webauthn_ceremony.py` | `_generic_voice_evidence_revalidated_at_gate` | validator | call:validate_voice_source_bundle | 1192 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | hash | call:_action_params_hash_from_durable_selection | 1530 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | source_bundle | call:_envelope_from_durable_selection | 1533 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | hash | call:work_request_envelope_hash | 1539 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | hash | definition | 1502 |
| `core/governance/s7_webauthn_ceremony.py` | `authorization_voice_seat_recheck` | validator | call:consultation_exemption_admits | 1039 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_begin` | hash | call:_r11_challenge_projection_hash | 427 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_begin` | durable_writer | call:create_authorization_challenge | 468 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | constructor | call:S7AuthorizationArtifact | 868 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | hash | call:_r11_challenge_projection_hash | 565 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | source_bundle | call:authorization_challenge_for_finish | 547 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | validator | call:consultation_exemption_admits | 641 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | constructor | call:mint_authorization_artifact | 892 |
| `core/governance/s7_webauthn_ceremony.py` | `build_backup_registration_envelope` | producer | call:build_work_request_envelope | 62 |
| `core/governance/s7_webauthn_ceremony.py` | `build_disable_credential_envelope` | producer | call:build_work_request_envelope | 102 |
