...
| `core/governance/s7_guarded_execution.py` | `S7GuardedStateStore.put_artifact_under_consultation_exemption` | durable_writer | definition | 3461 |
| `core/governance/s7_guarded_execution.py` | `S7VoiceConsultationBundleStore.put_bundle` | durable_writer | definition | 2456 |
| `core/governance/s7_guarded_execution.py` | `_bundle_content_hash_valid` | hash | call:s7_voice_consultation_bundle_hash | 3061 |
| `core/governance/s7_guarded_execution.py` | `_bundle_matches_expected_hash_binding` | validator | definition | 3034 |
...
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_expected_r11_exemption_evidence_contract | 2943 |
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_r11_exemption_evidence_contract | 2940 |
| `core/governance/s7_guarded_execution.py` | `_voice_bundle_from_row` | source_bundle | call:S7VoiceConsultationBundle | 1708 |
| `core/governance/s7_guarded_execution.py` | `_voice_validation_result_v2` | hash | call:s7_voice_consultation_bundle_hash | 1842 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | call:S7VoiceSourceBundleHashBinding | 1136 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:maez_voice_consultation_hash | 1120 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:work_request_envelope_hash | 1119 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | definition | 1100 |
| `core/governance/s7_guarded_execution.py` | `get_for_source_ref` | source_bundle | call:S7VoiceConsultationBundle | 2557 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:authorization_store.put | 3611 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | validator | call:exemption_admits_for_artifact | 3588 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_under_consultation_exemption | 3597 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_with_bundle_reservation | 3603 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | constructor | definition | 3541 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:S7VoiceConsultationBundle | 1240 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:attempt_store.put | 1216 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:derive_s7_voice_source_bundle_hash_binding | 1198 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:put_voice_source_bundle_v2 | 1272 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | hash | call:s7_voice_consultation_bundle_hash | 1269 |
...
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:_insert_r11_exemption_evidence | 3495 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | validator | call:exemption_admits_for_artifact | 3482 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:self.authorization_store.put | 3494 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | call:self.authorization_store.put | 3538 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | definition | 3501 |
| `core/governance/s7_guarded_execution.py` | `put_bundle` | hash | call:s7_voice_consultation_bundle_hash | 2462 |
| `core/governance/s7_guarded_execution.py` | `put_voice_source_bundle_v2` | hash | call:s7_voice_consultation_bundle_hash | 1754 |
...
| `core/governance/s7_guarded_execution.py` | `s7_voice_consultation_bundle_hash` | hash | definition | 1545 |
| `core/governance/s7_guarded_execution.py` | `validate_s7_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 3285 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 1945 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:_voice_source_bundle_binding_hash | 1928 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:s7_voice_consultation_bundle_hash | 1931 |
