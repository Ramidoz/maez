...
| `core/governance/birth_authorization.py` | `build_birth_envelope` | producer | call:build_work_request_envelope | 234 |
| `core/governance/birth_authorization.py` | `mint_and_consume_birth_authorization` | renderer | call:render_request_statement | 720 |
| `core/governance/birth_authorization.py` | `mint_and_consume_birth_authorization` | durable_writer | call:consume_for_execution_with_committed_row | 846 |
| `core/governance/operator_user_boundary.py` | `work_request_envelope_hash` | hash | definition | 1335 |
| `core/governance/operator_user_boundary.py` | `build_request_history_record` | hash | call:work_request_envelope_hash | 1420 |
| `core/governance/operator_user_boundary.py` | `build_work_request_envelope` | producer | definition | 1540 |
| `core/governance/operator_user_boundary.py` | `build_work_request_envelope` | producer | call:WorkRequestEnvelope | 1578 |
| `core/governance/operator_user_boundary.py` | `maez_voice_consultation_hash` | hash | definition | 1656 |
| `core/governance/operator_user_boundary.py` | `voice_consultation_satisfies_request` | hash | call:work_request_envelope_hash | 1674 |
| `core/governance/operator_user_boundary.py` | `authorization_artifact_matches` | validator | definition | 2442 |
| `core/governance/operator_user_boundary.py` | `committed_grant_row_proves_founder_self_modification` | validator | definition | 2635 |
| `core/governance/operator_user_boundary.py` | `_mint_s7_execution_grant` | constructor | definition | 2677 |
| `core/governance/operator_user_boundary.py` | `_mint_s7_execution_grant` | constructor | call:S7ExecutionGrant | 2693 |
| `core/governance/operator_user_boundary.py` | `_open_s7_connection_from_held_store` | constructor | definition | 2778 |
| `core/governance/operator_user_boundary.py` | `_open_s7_connection_from_held_store` | constructor | call:_S7HeldConnectionBinding | 2790 |
| `core/governance/operator_user_boundary.py` | `s7_held_store_transaction` | constructor | call:_open_s7_connection_from_held_store | 2874 |
| `core/governance/operator_user_boundary.py` | `_require_verified_held_connection` | validator | definition | 2899 |
| `core/governance/operator_user_boundary.py` | `_held_store` | constructor | call:_open_s7_connection_from_held_store | 2974 |
| `core/governance/operator_user_boundary.py` | `_read_committed_grant_row_after_commit` | source_bundle | definition | 3156 |
| `core/governance/operator_user_boundary.py` | `_read_committed_grant_row_after_commit` | source_bundle | call:CommittedGrantRow | 3199 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_on_connection` | durable_writer | definition | 3202 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_on_connection` | validator | call:_require_verified_held_connection | 3218 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_on_connection` | constructor | call:_mint_s7_execution_grant | 3341 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_with_committed_row` | durable_writer | definition | 3370 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_with_committed_row` | durable_writer | call:consume_for_execution_on_connection | 3386 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_with_committed_row` | source_bundle | call:_CommittedConsumptionConnection | 3402 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution_with_committed_row` | source_bundle | call:_read_committed_grant_row_after_commit | 3405 |
| `core/governance/operator_user_boundary.py` | `S7AuthorizationStore.put` | durable_writer | definition | 3523 |
| `core/governance/operator_user_boundary.py` | `consume_verified` | durable_writer | call:consume_for_execution | 3660 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution` | durable_writer | definition | 3677 |
| `core/governance/operator_user_boundary.py` | `consume_for_execution` | durable_writer | call:consume_for_execution_on_connection | 3693 |
| `core/governance/operator_user_boundary.py` | `anchored_transaction` | constructor | call:_open_s7_connection_from_held_store | 3736 |
| `core/governance/operator_user_boundary.py` | `execution_grant_authorizes_action` | execution_edge | definition | 3796 |
| `core/governance/operator_user_boundary.py` | `consume_execution_grant_for_action` | execution_edge | definition | 3833 |
| `core/governance/operator_user_boundary.py` | `consume_execution_grant_for_action` | execution_edge | call:execution_grant_authorizes_action | 3840 |
| `core/governance/operator_user_boundary.py` | `execution_grant_authorizes_card_transition` | execution_edge | definition | 3851 |
| `core/governance/operator_user_boundary.py` | `execution_grant_authorizes_card_transition` | execution_edge | call:execution_grant_authorizes_action | 3867 |
| `core/governance/operator_user_boundary.py` | `brain_swap_execution_precondition_hash` | hash | definition | 3989 |
| `core/governance/operator_user_boundary.py` | `build_brain_swap_work_request_envelope` | hash | call:brain_swap_execution_precondition_hash | 4036 |
| `core/governance/operator_user_boundary.py` | `build_brain_swap_work_request_envelope` | producer | call:build_work_request_envelope | 4040 |
| `core/governance/operator_user_boundary.py` | `brain_swap_execution_authorized` | hash | call:brain_swap_execution_precondition_hash | 4090 |
| `core/governance/operator_user_boundary.py` | `brain_swap_execution_authorized` | hash | call:work_request_envelope_hash | 4106 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | renderer | definition | 5184 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | validator | call:consultation_exemption_admits | 5247 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | hash | call:maez_voice_consultation_hash | 5267 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | hash | call:work_request_envelope_hash | 5278 |
| `core/governance/operator_user_boundary.py` | `render_request_statement` | renderer | call:RenderedRequestStatement | 5307 |
| `core/governance/s7_consultation_exemption.py` | `_exemption_from_persisted_projection` | source_bundle | definition | 172 |
| `core/governance/s7_consultation_exemption.py` | `_exemption_from_persisted_projection` | constructor | call:S7ConsultationExemption | 180 |
| `core/governance/s7_consultation_exemption.py` | `mint_consultation_exemption` | producer | definition | 197 |
| `core/governance/s7_consultation_exemption.py` | `mint_consultation_exemption` | validator | call:_envelope_matches_durable_selection | 220 |
| `core/governance/s7_consultation_exemption.py` | `mint_consultation_exemption` | hash | call:_action_params_hash_from_durable_selection | 228 |
| `core/governance/s7_consultation_exemption.py` | `mint_consultation_exemption` | constructor | call:S7ConsultationExemption | 235 |
| `core/governance/s7_consultation_exemption.py` | `mint_consultation_exemption` | hash | call:work_request_envelope_hash | 237 |
| `core/governance/s7_consultation_exemption.py` | `exemption_admits_for_artifact` | validator | definition | 316 |
| `core/governance/s7_consultation_exemption.py` | `exemption_admits_for_artifact` | source_bundle | call:_envelope_from_durable_selection | 353 |
| `core/governance/s7_consultation_exemption.py` | `exemption_admits_for_artifact` | hash | call:work_request_envelope_hash | 356 |
| `core/governance/s7_consultation_exemption.py` | `exemption_admits_for_artifact` | hash | call:_action_params_hash_from_durable_selection | 381 |
| `core/governance/s7_consultation_exemption.py` | `consultation_exemption_admits` | validator | definition | 441 |
| `core/governance/s7_consultation_exemption.py` | `consultation_exemption_admits` | validator | call:_envelope_matches_durable_selection | 471 |
| `core/governance/s7_consultation_exemption.py` | `consultation_exemption_admits` | hash | call:_action_params_hash_from_durable_selection | 482 |
| `core/governance/s7_consultation_exemption.py` | `consultation_exemption_admits` | hash | call:work_request_envelope_hash | 492 |
| `core/governance/s7_consultation_exemption.py` | `_action_params_hash_from_durable_selection` | hash | definition | 500 |
...
| `core/governance/s7_consultation_exemption.py` | `_envelope_from_durable_selection` | source_bundle | definition | 515 |
| `core/governance/s7_consultation_exemption.py` | `_envelope_from_durable_selection` | producer | call:_cutover_envelope_from_durable_selection | 523 |
| `core/governance/s7_consultation_exemption.py` | `_envelope_matches_durable_selection` | validator | definition | 531 |
| `core/governance/s7_consultation_exemption.py` | `_envelope_matches_durable_selection` | source_bundle | call:_envelope_from_durable_selection | 532 |
| `core/governance/s7_guarded_execution.py` | `_r11_exemption_evidence_contract` | validator | definition | 94 |
| `core/governance/s7_guarded_execution.py` | `_expected_r11_exemption_evidence_contract` | validator | definition | 121 |
| `core/governance/s7_guarded_execution.py` | `_expected_r11_exemption_evidence_contract` | validator | call:_r11_exemption_evidence_contract | 124 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | durable_writer | definition | 129 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | constructor | call:_open_s7_connection_from_held_store | 139 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_r11_exemption_evidence_contract | 174 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_expected_r11_exemption_evidence_contract | 177 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_r11_exemption_evidence_contract | 182 |
| `core/governance/s7_guarded_execution.py` | `_provision_r11_exemption_evidence_at` | validator | call:_expected_r11_exemption_evidence_contract | 183 |
| `core/governance/s7_guarded_execution.py` | `provision_r11_exemption_evidence` | durable_writer | definition | 216 |
| `core/governance/s7_guarded_execution.py` | `provision_r11_exemption_evidence` | durable_writer | call:_provision_r11_exemption_evidence_at | 220 |
| `core/governance/s7_guarded_execution.py` | `_r11_artifact_projection` | hash | definition | 223 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | durable_writer | definition | 253 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | validator | call:_r11_exemption_evidence_contract | 260 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | validator | call:_expected_r11_exemption_evidence_contract | 261 |
| `core/governance/s7_guarded_execution.py` | `_insert_r11_exemption_evidence` | hash | call:_r11_artifact_projection | 287 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | definition | 318 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:_require_verified_held_connection | 326 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:_r11_exemption_evidence_contract | 332 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:_expected_r11_exemption_evidence_contract | 333 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | constructor | call:S7AuthorizationArtifact | 369 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | source_bundle | call:_exemption_from_persisted_projection | 426 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | hash | call:_r11_artifact_projection | 431 |
| `core/governance/s7_guarded_execution.py` | `revalidate_r11_exemption_for_consumption` | validator | call:exemption_admits_for_artifact | 461 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | definition | 1111 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:work_request_envelope_hash | 1130 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | hash | call:maez_voice_consultation_hash | 1131 |
| `core/governance/s7_guarded_execution.py` | `derive_s7_voice_source_bundle_hash_binding` | source_bundle | call:S7VoiceSourceBundleHashBinding | 1147 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:derive_s7_voice_source_bundle_hash_binding | 1209 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:attempt_store.put | 1227 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | source_bundle | call:S7VoiceConsultationBundle | 1251 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | hash | call:s7_voice_consultation_bundle_hash | 1280 |
| `core/governance/s7_guarded_execution.py` | `persist_s7_voice_source_bundle_for_material` | durable_writer | call:put_voice_source_bundle_v2 | 1283 |
| `core/governance/s7_guarded_execution.py` | `s7_voice_consultation_bundle_hash` | hash | definition | 1556 |
| `core/governance/s7_guarded_execution.py` | `_voice_bundle_from_row` | source_bundle | call:S7VoiceConsultationBundle | 1719 |
| `core/governance/s7_guarded_execution.py` | `put_voice_source_bundle_v2` | hash | call:s7_voice_consultation_bundle_hash | 1765 |
| `core/governance/s7_guarded_execution.py` | `_voice_validation_result_v2` | hash | call:s7_voice_consultation_bundle_hash | 1853 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:_voice_source_bundle_binding_hash | 1939 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | hash | call:s7_voice_consultation_bundle_hash | 1942 |
| `core/governance/s7_guarded_execution.py` | `validate_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 1956 |
| `core/governance/s7_guarded_execution.py` | `S7VoiceConsultationBundleStore.put_bundle` | durable_writer | definition | 2467 |
| `core/governance/s7_guarded_execution.py` | `put_bundle` | hash | call:s7_voice_consultation_bundle_hash | 2473 |
| `core/governance/s7_guarded_execution.py` | `get_for_source_ref` | source_bundle | call:S7VoiceConsultationBundle | 2568 |
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_r11_exemption_evidence_contract | 2951 |
| `core/governance/s7_guarded_execution.py` | `_reserve_for_artifact_with_connection` | validator | call:_expected_r11_exemption_evidence_contract | 2954 |
| `core/governance/s7_guarded_execution.py` | `_bundle_matches_expected_hash_binding` | validator | definition | 3045 |
| `core/governance/s7_guarded_execution.py` | `_bundle_content_hash_valid` | hash | call:s7_voice_consultation_bundle_hash | 3072 |
| `core/governance/s7_guarded_execution.py` | `validate_s7_voice_source_bundle` | validator | call:_bundle_matches_expected_hash_binding | 3296 |
| `core/governance/s7_guarded_execution.py` | `S7GuardedStateStore.put_artifact_under_consultation_exemption` | durable_writer | definition | 3472 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | validator | call:exemption_admits_for_artifact | 3493 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:self.authorization_store.put | 3505 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_under_consultation_exemption` | durable_writer | call:_insert_r11_exemption_evidence | 3506 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | definition | 3512 |
| `core/governance/s7_guarded_execution.py` | `put_artifact_with_bundle_reservation` | durable_writer | call:self.authorization_store.put | 3550 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | constructor | definition | 3558 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | validator | call:exemption_admits_for_artifact | 3622 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_under_consultation_exemption | 3631 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:put_artifact_with_bundle_reservation | 3637 |
| `core/governance/s7_guarded_execution.py` | `mint_authorization_artifact` | durable_writer | call:authorization_store.put | 3650 |
| `core/governance/s7_webauthn_bootstrap.py` | `S7WebAuthnBootstrapStore.create_authorization_challenge` | durable_writer | definition | 995 |
| `core/governance/s7_webauthn_bootstrap.py` | `S7WebAuthnBootstrapStore.authorization_challenge_for_finish` | source_bundle | definition | 1247 |
| `core/governance/s7_webauthn_ceremony.py` | `build_backup_registration_envelope` | producer | call:build_work_request_envelope | 63 |
| `core/governance/s7_webauthn_ceremony.py` | `build_disable_credential_envelope` | producer | call:build_work_request_envelope | 103 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_begin` | hash | call:_r11_challenge_projection_hash | 678 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_begin` | durable_writer | call:create_authorization_challenge | 768 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | source_bundle | call:authorization_challenge_for_finish | 849 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | hash | call:_r11_challenge_projection_hash | 903 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | validator | call:consultation_exemption_admits | 979 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | constructor | call:S7AuthorizationArtifact | 1206 |
| `core/governance/s7_webauthn_ceremony.py` | `authorize_finish` | constructor | call:mint_authorization_artifact | 1266 |
| `core/governance/s7_webauthn_ceremony.py` | `authorization_voice_seat_recheck` | validator | call:consultation_exemption_admits | 1422 |
| `core/governance/s7_webauthn_ceremony.py` | `_generic_voice_evidence_revalidated_at_gate` | hash | call:maez_voice_consultation_hash | 1560 |
| `core/governance/s7_webauthn_ceremony.py` | `_generic_voice_evidence_revalidated_at_gate` | source_bundle | call:read_voice_source_bundle | 1569 |
| `core/governance/s7_webauthn_ceremony.py` | `_generic_voice_evidence_revalidated_at_gate` | validator | call:validate_voice_source_bundle | 1575 |
| `core/governance/s7_webauthn_ceremony.py` | `_consume_backup_registration_authorization` | durable_writer | call:consume_for_execution | 1754 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | hash | definition | 1885 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | hash | call:_action_params_hash_from_durable_selection | 1913 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | source_bundle | call:_envelope_from_durable_selection | 1916 |
| `core/governance/s7_webauthn_ceremony.py` | `_r11_challenge_projection_hash` | hash | call:work_request_envelope_hash | 1922 |
| `daemon/maez_daemon.py` | `_s7_authorization_route_material` | source_bundle | call:authorization_challenge_for_finish | 605 |
| `daemon/maez_daemon.py` | `_s7_authorization_route_material` | renderer | call:render_request_statement | 623 |
| `daemon/maez_daemon.py` | `_s7_voice_source_validation_for_material` | source_bundle | call:derive_s7_voice_source_bundle_hash_binding | 668 |
| `daemon/maez_daemon.py` | `_s7_voice_source_validation_for_material` | source_bundle | call:read_voice_source_bundle | 677 |
| `daemon/maez_daemon.py` | `_s7_voice_source_validation_for_material` | validator | call:validate_voice_source_bundle | 681 |
| `daemon/maez_daemon.py` | `_s7_founder_seen_voice_hash_valid` | source_bundle | call:read_voice_source_bundle | 798 |
| `daemon/maez_daemon.py` | `_s7_disable_credential_for_proof` | durable_writer | call:consume_for_execution | 1124 |
| `daemon/maez_daemon.py` | `_s7_disable_credential_for_proof` | execution_edge | call:consume_execution_grant_for_action | 1138 |
| `scripts/cuda_cutover.py` | `ValidatedCutoverSelection.__post_init__` | constructor | definition | 308 |
| `scripts/cuda_cutover.py` | `_cutover_action_preimage` | hash | definition | 317 |
| `scripts/cuda_cutover.py` | `_action_params_hash_from_durable_selection` | hash | definition | 351 |
| `scripts/cuda_cutover.py` | `_action_params_hash_from_durable_selection` | hash | call:_cutover_action_preimage | 359 |
| `scripts/cuda_cutover.py` | `_cutover_envelope_from_durable_selection` | producer | definition | 362 |
| `scripts/cuda_cutover.py` | `_cutover_envelope_from_durable_selection` | producer | call:build_work_request_envelope | 373 |
| `scripts/cuda_cutover.py` | `_cutover_envelope_from_durable_selection` | hash | call:_cutover_action_preimage | 376 |
| `scripts/cuda_cutover.py` | `_reconstruct_selected_cutover_at` | constructor | definition | 535 |
| `scripts/cuda_cutover.py` | `_reconstruct_selected_cutover_at` | constructor | call:ValidatedCutoverSelection | 735 |
| `scripts/cuda_cutover.py` | `require_current_named_identity` | constructor | call:_require_verified_held_connection | 805 |
| `scripts/cuda_cutover.py` | `open_existing_authorization_store` | constructor | call:_open_s7_connection_from_held_store | 985 |
| `scripts/cuda_cutover.py` | `_conn` | constructor | call:_open_s7_connection_from_held_store | 1148 |
| `scripts/cuda_cutover.py` | `publish_and_validate_burn` | execution_edge | call:consume_execution_grant_for_action | 1700 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | hash | call:_cutover_action_preimage | 3236 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | producer | call:_cutover_envelope_from_durable_selection | 3258 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | producer | call:mint_consultation_exemption | 3264 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | renderer | call:render_request_statement | 3273 |
| `scripts/cuda_cutover.py` | `_revalidate_r11_after_consume` | validator | call:revalidate_r11_exemption_for_consumption | 3374 |
| `scripts/cuda_cutover.py` | `_authorize_and_stage_selected_cutover` | durable_writer | call:consume_for_execution_with_committed_row | 3393 |
...
**Amendment (2026-08-28, owner-authorized): 186 -> 190.** Group A — three
public birth-authority roads in `core/governance/birth_authorization.py`
(created 2026-08-27, after the 2026-08-13 ratification) are ratified here:
`build_work_request_envelope`, `consume_for_execution_with_committed_row`
and `render_request_statement`. Each was proven to implement a frozen birth
requirement, to bind the exact request (envelope hash, params hash,
precondition hash, and the owner manifest sha256 riding `free_text_ref_hash`),
to fail closed across 53 refusal sites, to be unable to widen authority
(`derive_work_class` is action-exact and content-blind for
`ledger.birth_ceremony`, and a claimed `birth_activation` on any other action
degrades to `routine_custody`), and to have no parallel weaker route — the
raw-string receipt died in the thirteenth round.

Group B — two roads that reached past the underscore into
`_open_s7_connection_from_held_store` were NOT ratified. They are REPLACED by
`s7_held_store_transaction`, a reviewed public seam whose contract names
permitted purpose, transaction lifetime, authority scope and rollback
behaviour. That seam's own constructor call is the fourth new row. A
path-based API could not substitute: the store must be reached through
descriptors the caller already holds, opened O_NOFOLLOW, so path resolution
happens once and cannot be redirected before the atomic consume.

**Counts, derived mechanically:** constructor 21, durable_writer 33, execution_edge 10, hash 47, producer 15, renderer 5, source_bundle 23, validator 36 — **total 190**.
