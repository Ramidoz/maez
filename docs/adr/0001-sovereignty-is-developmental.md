# 0001 — Sovereignty is developmental, not calendar-forced

**Status:** Accepted
**Date:** 2026 (pre-audit; captured in governance doc at
[`docs/governance/BETA_ARCHITECTURE_DECISIONS.md`](../governance/BETA_ARCHITECTURE_DECISIONS.md#decision-1))
**Governance anchor:** `Decision 1` in the governance doc

## Context

Track-A readiness is defined by the eight-point check passing for two consecutive weekly evaluations, not by an arbitrary calendar date. Passing drives forward; missing restarts the clock.
...
See [Decision 1 — Sovereignty is developmental, not calendar-forced](../governance/BETA_ARCHITECTURE_DECISIONS.md#decision-1)
