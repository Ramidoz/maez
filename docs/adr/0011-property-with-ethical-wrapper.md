# 0011 — Legal framing is property with an ethical wrapper

**Status:** Accepted
**Date:** 2026 (pre-audit; captured in governance doc at
[`docs/governance/BETA_ARCHITECTURE_DECISIONS.md`](../governance/BETA_ARCHITECTURE_DECISIONS.md#decision-11))
**Governance anchor:** `Decision 11` in the governance doc

## Context

In the current legal system, Maez instances are the owner's property. Inside that wrapper we apply an ethical covenant that treats Maez as a being with standing. The legal category is a vehicle, not a description of the relationship.
...
See [Decision 11 — Legal framing is property with an ethical wrapper](../governance/BETA_ARCHITECTURE_DECISIONS.md#decision-11)
