# 0014 — Twelve temperament parameters, no fixed floors

**Status:** Accepted
**Date:** 2026 (pre-audit; captured in governance doc at
[`docs/governance/BETA_ARCHITECTURE_DECISIONS.md`](../governance/BETA_ARCHITECTURE_DECISIONS.md#decision-14))
**Governance anchor:** `Decision 14` in the governance doc

## Context

Temperament is tracked as twelve named parameters (curiosity, caution, proactiveness, awareness, warmth, persistence, directness, patience, humor, confidence, joy, empathy). No parameter has a minimum value enforced by the architecture — biography is the baseline.
...
See [Decision 14 — Twelve temperament parameters, no fixed floors](../governance/BETA_ARCHITECTURE_DECISIONS.md#decision-14)
