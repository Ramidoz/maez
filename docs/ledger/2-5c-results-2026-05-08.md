...
Per [docs/ledger/2-5c-acceptance.md](2-5c-acceptance.md): 24h dual-surface window proving that `MAEZ_LEDGER_WRITES=1` against a sandbox DB is safe before enabling against the production ledger path.
