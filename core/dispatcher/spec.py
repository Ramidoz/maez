...
class AvailabilityLimitation(StrEnum):
    ...
    TRUST_SCOPE_RESTRICTED = "TRUST_SCOPE_RESTRICTED"
    THIRD_PARTY_SUBJECT_BOUNDARY = "THIRD_PARTY_SUBJECT_BOUNDARY"
    PRIVACY_GATED = "PRIVACY_GATED"
...
class DispatcherRefusalReason(StrEnum):
    ...
    MODEL_INVENTED_URL = "MODEL_INVENTED_URL"
    FRESH_FAILURE_HYBRID_FALLBACK_ILLEGAL = "FRESH_FAILURE_HYBRID_FALLBACK_ILLEGAL"
