...
DIRECT_CALLER_INVENTORY = {
    ...
    ("daemon/maez_daemon.py", 6854),
    ("daemon/maez_daemon.py", 7215),
    ("daemon/maez_daemon.py", 7339),
    ("daemon/maez_daemon.py", 7728),
    ("daemon/maez_daemon.py", 9387),
    ("daemon/maez_daemon.py", 9581),
    ("daemon/maez_daemon.py", 11215),
    ("skills/telegram_voice.py", 53),
    ("skills/telegram_voice.py", 2823),
    ("skills/telegram_voice.py", 2877),
}
