...
DIRECT_CALLER_INVENTORY = {
    ...
    ("daemon/maez_daemon.py", 3657),
    ("daemon/maez_daemon.py", 5205),
    ("daemon/maez_daemon.py", 5412),
    ("daemon/maez_daemon.py", 7039),
    ("skills/telegram_voice.py", 47),
    ("skills/telegram_voice.py", 2714),
    ("skills/telegram_voice.py", 2768),
