...
DIRECT_CALLER_INVENTORY = {
    ...
    ("daemon/maez_daemon.py", 8384),
    ("daemon/maez_daemon.py", 10143),
    ("daemon/maez_daemon.py", 10339),
    ("daemon/maez_daemon.py", 11974),
    ("skills/telegram_voice.py", 54),
    ("skills/telegram_voice.py", 2962),
    ("skills/telegram_voice.py", 3016),
}
