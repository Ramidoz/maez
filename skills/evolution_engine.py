...
def _generate_patch_intent(weakness: str, evidence: dict, editable_targets: list,
    ...
    prompt = (
        ...
        f"- human_rationale is the message Rohit (the user) will see. Write it so\n"
...
def _enrich_intent(intent: dict, editable_targets: list) -> dict:
    ...
    # the proposal card always has plain-English text for Rohit.
...
def process_proposal_job(job_id: int) -> dict:
    ...
    # Notify Rohit via canonical display + compact card (Session 11x:
