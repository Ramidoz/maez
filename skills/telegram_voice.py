...
# ───────────────────────────────────────────────────────────────────────
#
# Rohit's ask: "I want Maez to be able to execute any query of mine
...
#
# Tier handling: Rohit's chat message IS the authorization. Tier 0/1/2
...
# transcript so the LLM can tell Rohit honestly.
...
_TOOL_MANIFEST = """\
TOOLS YOU CAN USE (your body, your hands — these run on Rohit's machine):
...
9. install_package {"package":"openrgb","reason":"Rohit asked"}
...
DONE
when you have enough information to answer Rohit.
...
- Rohit asking you to do something IS authorization. Don't ask "should I?" — do it, then tell him what you did.
"""
...
class TelegramVoice:
    def __init__(self, memory: MemoryManager, daemon=None):
        ...
        # Session 11m: optional daemon ref for the "Rohit is talking" backoff
    ...
    # ═════════════════════════════════════════════════════════════════════
    #
    # Rohit shouldn't have to type /approve_evolution 22 to approve a
    ...
    # ═════════════════════════════════════════════════════════════════════
    #
    # Strict: only triggers on imperative phrases where Rohit is clearly
    ...
    # the Rohit-said-search-the-internet case that caused fabrication
    # today.
    ...
    def _run_jarvis_loop(self, user_text: str, max_iters: int = 4) -> str:
        ...
        when Rohit asks, instead of saying 'I'll check' as text and never
        ...
        lines = [
            "[JARVIS TRANSCRIPT — you actually executed these on Rohit's machine just now.",
            " Tell Rohit naturally what you did and what you found. Don't list raw output;",
    ...
    async def _process_message(self, update, context, user_text: str) -> str:
        ...
        try:
            ...
            # Session 11m: signal the daemon that Rohit is actively talking so
