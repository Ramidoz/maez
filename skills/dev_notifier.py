...
# Session 11x: plain-English usefulness labels shown to Rohit, instead of
# raw rubric words. Rohit doesn't care whether the proposal is 2/3 or 3/3
...
def send_proposal_card(candidate_id, weakness, target, before, after,
    ...
    # the card where Rohit sees the internal variable name, and it's
