...
#
# ------------------------------------------------------------------
# VENDORED FILE — derived from Hermes Agent
#   https://github.com/NousResearch/hermes-agent
#   Upstream path: gateway/platforms/base.py
#   Upstream license: MIT
#
#   Copyright (c) 2024-2026 Nous Research
#   Licensed under the MIT License.
#
# Redistributed here under AGPLv3 within the Maez project.
# The upstream MIT copyright is preserved per MIT's redistribution
# requirements. Non-structural edits (import-path rewrites, branding
# cleanup) have been applied — see skills/surface/_LICENSE_ATTRIBUTION.md
# for the manifest of changes.
# ------------------------------------------------------------------
...
from skills.surface.session import SessionSource, build_session_key
from skills.surface.maez_surface_paths import get_hermes_dir
...
class BasePlatformAdapter(ABC):
    ...
    def _mark_connected(self) -> None:
        ...
        self._fatal_error_retryable = True
        try:
            from skills.surface._gateway_stubs import write_runtime_status
    ...
    def _acquire_platform_lock(self, scope: str, identity: str, resource_desc: str) -> bool:
        ...
        from skills.surface._gateway_stubs import acquire_scoped_lock
    ...
    def _release_platform_lock(self) -> None:
        ...
        if not identity:
            return
        from skills.surface._gateway_stubs import release_scoped_lock
    ...
    async def handle_message(self, event: MessageEvent) -> None:
        ...
        if session_key in self._active_sessions:
            ...
            from skills.surface._gateway_stubs import should_bypass_active_session
