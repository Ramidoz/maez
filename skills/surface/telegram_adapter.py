...
#   Upstream path: gateway/platforms/telegram.py
...
from skills.surface.telegram_network import (
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _persist_dm_topic_thread_id(self, chat_id: int, topic_name: str, thread_id: int) -> None:
        ...
        try:
            from skills.surface._gateway_stubs import get_hermes_home
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                from skills.surface._gateway_stubs import telegram_menu_commands
    ...
    async def send_model_picker(
        ...
        try:
            from skills.surface._gateway_stubs import get_label
        except ImportError:
            def get_label(slug):
                return slug
    ...
    def _text_batch_key(self, event: MessageEvent) -> str:
        ...
        from skills.surface.session import build_session_key
    ...
    async def _handle_sticker(self, msg: Message, event: "MessageEvent") -> None:
        ...
        """
        from skills.surface._gateway_stubs import (
    ...
    def _build_message_event(
        ...
        from skills.surface.platform_base import resolve_channel_prompt
